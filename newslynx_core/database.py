...
def ensure_schema():
  ...
  # HOMEPAGES
  homepages.create_column('homepage' , String) 
  homepages.create_column('homepage_id' , String) 
  homepages.create_column('org_id', String) 
  homepages.create_column('datetime', DateTime) 
  homepages.create_column('headline' , String) 
  homepages.create_column('url', String)
  homepages.create_column('font_size' , Numeric)
  homepages.create_column('x' , Numeric)
  homepages.create_column('y' , Numeric)
  homepages.create_column('x_bucket', Numeric) 
  homepages.create_column('y_bucket', Numeric)
  homepages.create_column('bucket', Numeric)
  homepages.create_column('has_img', Numeric)
  homepages.create_column('img_width', Numeric)
